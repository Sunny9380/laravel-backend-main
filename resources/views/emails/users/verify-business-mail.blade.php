                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td align="center" valign="top" style="padding: 36px 24px;">
                                <a href="{{ env('FRONTEND_URL') }}/asset/logo/logo.png" target="_blank"
                                    style="display: inline-block;">
                                    <img src="{{ env('FRONTEND_URL') }}" alt="Logo" border="0" width="48"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        ...
                        <tr>
                            <td align="left" bgcolor="#ffffff"
                                ...
                                <p style="margin: 0;">Tap the button below to confirm your email address. If you didn't
                                    create an account with, you can safely delete
                                    this email.</p>
                            </td>
                        </tr>
                        <!-- end copy -->
                        ...
                        <tr>
                            <td align="left" bgcolor="#ffffff"
                                ...
                                <p style="margin: 0;">From,<br> {{ env('APP_NAME') }}</p>
                            </td>
                        </tr>
                        <!-- end copy -->
                        ...
                        <tr>
                            <td align="center" bgcolor="#e9ecef"
                                ...
                                <p style="margin: 0;">You received this email because we received a request for
                                    business email verification for your account. If you didn't request business email
